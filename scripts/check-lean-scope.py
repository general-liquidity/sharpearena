#!/usr/bin/env python3
"""Require every Lean module in the SharpeArenaFormal library to declare its scope.
...
The library is the root module ``formal/SharpeArenaFormal.lean`` together with every ``.lean``
file under ``formal/SharpeArenaFormal/``, at any depth, so a new module cannot escape the
