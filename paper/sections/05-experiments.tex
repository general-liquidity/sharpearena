...
Ten findings: eight core calibrations plus two reviewer-motivated probes. Each subsection states the entry point, seeds and quantity measured, then reports numbers from committed JSON and figures. The exact commands are listed in \cref{app:commands}. The original evidence records SharpeBench 0.5.0 under \texttt{sharpearena} 0.8.0; the concave-impact and predictability extensions were produced on the v0.11.0 source tree, with their configuration serialized beside their results.
