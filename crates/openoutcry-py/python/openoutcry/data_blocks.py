...
Synthetic OpenOutcry paths are continuous by construction, but a real CSV
...
def block_windows(
    ...
    :class:`~openoutcry.gym.OpenOutcryEnv` consumes.
    """
    if horizon < 1:
...
def make_block_env(
    ...
    **env_kwargs,
    ...
    """Construct an :class:`~openoutcry.gym.OpenOutcryEnv` over a seed-chosen in-block
