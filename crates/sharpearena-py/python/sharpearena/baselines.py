"""Reference baseline policies and a leaderboard runner for SharpeArena.
...
def _make_env(
    ...
    try:
        ...
        return SharpeArenaEnv(n_symbols=n_symbols, n_days=n_days, seed=seed)
...
def run_baselines(
    *,
    ...
    ``arena_deflated_sharpe_ci``. The packaged scorer pins SharpeBench 0.21.0, which
