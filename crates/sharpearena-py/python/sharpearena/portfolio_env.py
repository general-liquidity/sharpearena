"""Portfolio-allocation env over SharpeArena's leak-free price panel.

:class:`PortfolioEnv` reframes the single-instrument, position-style
:class:`~sharpearena.gym.SharpeArenaEnv` as the canonical RL-finance allocation task: a
...
class PortfolioEnv(gym.Env):
    ...
    Wraps an :class:`~sharpearena.gym.SharpeArenaEnv`; all constructor parameters not named
