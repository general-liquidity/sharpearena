"""Tests for :class:`sharpearena.obs_extra.KalmanTrendObservation`.
...
known; the integration test over a real :class:`SharpeArenaEnv` is skipped when the
...
from sharpearena.obs_extra import KalmanTrendObservation
...
def test_wraps_real_env():
    ...
    base = SharpeArenaEnv(n_symbols=3, n_days=80, seed=1)
