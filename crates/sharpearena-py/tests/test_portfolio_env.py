"""Tests for :class:`sharpearena.portfolio_env.PortfolioEnv`.
...
from sharpearena.portfolio_env import PortfolioEnv
...
def test_log_return_matches_underlying_cost_model():
    ...
    a raw SharpeArenaEnv fed the asset slice prices the move with fees/slippage."""
    ...
    raw = SharpeArenaEnv(n_symbols=4, n_days=80, seed=7, allow_short=False, max_weight=1.0)
    raw.reset(seed=7)
