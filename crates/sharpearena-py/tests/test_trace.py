"""Tests for the rollout-trace schema (:mod:`sharpearena.trace`) and run-metrics
(:mod:`sharpearena.metrics`).

The env/score tests need the native ``sharpearena`` binding (for ``SharpeArenaEnv`` /
