...
import sharpearena  # noqa: F401  (ensures the package imports without pettingzoo)
import sharpearena.market_env as market_env
from sharpearena.market_env import EndogenousMarketEnv, make_aec_env
...
def test_import_works_and_construction_raises_without_pettingzoo():
    """`import sharpearena.market_env` succeeds without pettingzoo; constructing the env
