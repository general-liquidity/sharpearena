...
:class:`SharpeArenaEnv` are skipped when the compiled binding is unavailable.
...
from sharpearena.indicators import (
...
def test_make_preprocessed_env_with_indicators():
    from sharpearena.preprocessing import PreprocessingConfig, make_preprocessed_env
