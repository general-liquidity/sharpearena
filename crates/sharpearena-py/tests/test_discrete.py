...
Run from the crate dir after ``python -m maturin develop``::
    ...
    python -m pytest crates/sharpearena-py/tests/test_discrete.py -q
"""
...
from sharpearena.discrete import DiscreteAction


def _env(**kw) -> SharpeArenaEnv:
    return SharpeArenaEnv(n_symbols=kw.pop("n_symbols", 3), n_days=40, seed=1, **kw)
